...
namespace Dedup.ViewComponents
{
    ...
    public class PGRows : ViewComponent
    {
        ...
        /// <returns></returns>
        public async Task<IViewComponentResult> InvokeAsync(int id = 0, int page = 0, bool isRowsRead = true, ConnectorConfig connectorConfig = null, string ctid = null, string tab = null, int pagesize = 0)
        {
