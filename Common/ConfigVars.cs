...
namespace Dedup.Common
{
    public sealed class ConfigVars
    {
        ...
        private ConfigVars()
        {
            Environment.SetEnvironmentVariable("DATABASE_URL", "postgres://zgkjsguishplyl:e80d675d03d59b251c98aa01fb2d209e92105a7242a8659c85f66e4f3cb0fb66@ec2-54-175-117-212.compute-1.amazonaws.com:5432/dak816muevsf70");
            Environment.SetEnvironmentVariable("HEROKU_POSTGRESQL_NAVY_URL", "postgres://ayklzpgqdttlwq:680174d46e4c60a7ae2dc6f81169a158270b836fbfd5dc78a921af59e3069229@ec2-54-236-122-55.compute-1.amazonaws.com:5432/d3iq1d98husj74");
            //if (Utilities.HostingEnvironment.IsDevelopment())
            //{
            //    //Local

            //Environment.SetEnvironmentVariable("DATABASE_URL", "postgres://zgkjsguishplyl:e80d675d03d59b251c98aa01fb2d209e92105a7242a8659c85f66e4f3cb0fb66@ec2-54-175-117-212.compute-1.amazonaws.com:5432/dak816muevsf70");
            //Environment.SetEnvironmentVariable("HEROKU_POSTGRESQL_WHITE_URL", "postgres://ayklzpgqdttlwq:680174d46e4c60a7ae2dc6f81169a158270b836fbfd5dc78a921af59e3069229@ec2-54-236-122-55.compute-1.amazonaws.com:5432/d3iq1d98husj74");
            ...
            connectionString = ConnectionFactory.GetPGConnectionStringFromUrl(Environment.GetEnvironmentVariable("DATABASE_URL"));
            hangfireConnectionString = ConnectionFactory.GetPGConnectionStringFromUrl(Environment.GetEnvironmentVariable("HEROKU_POSTGRESQL_NAVY_URL"));
            if (Utilities.HostingEnvironment.IsStaging() || Utilities.HostingEnvironment.IsProduction())
            {
                Int32.TryParse(Environment.GetEnvironmentVariable("DEDUP_CTID_PAGE_SIZE"), out DEDUP_CTID_PAGE_SIZE);

                //DEDUP_CTID_PAGE_SIZE = ConnectionFactory.GetPGConnectionStringFromUrl(Environment.GetEnvironmentVariable("DEDUP_CTID_PAGE_SIZE"));
                connectionString = ConnectionFactory.GetPGConnectionStringFromUrl(Environment.GetEnvironmentVariable("DATABASE_URL"));
                hangfireConnectionString = ConnectionFactory.GetPGConnectionStringFromUrl(Environment.GetEnvironmentVariable("HEROKU_POSTGRESQL_WHITE_URL"));
            }
            else
            {
                // Int32.TryParse(Environment.GetEnvironmentVariable("DEDUP_CTID_PAGE_SIZE"), out DEDUP_CTID_PAGE_SIZE);
