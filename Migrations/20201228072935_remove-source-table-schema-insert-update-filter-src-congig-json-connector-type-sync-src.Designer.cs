...
namespace Dedup.Migrations
{
    ...
    [Migration("20201228072935_remove-source-table-schema-insert-update-filter-src-congig-json-connector-type-sync-src")]
    partial class removesourcetableschemainsertupdatefiltersrccongigjsonconnectortypesyncsrc
    {
